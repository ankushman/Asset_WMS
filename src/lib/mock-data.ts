...
export const INITIAL_WAREHOUSES: MockWarehouse[] = [
  ...
  },
  {
    ...
    pinCode: '500032',
    companyId: 'comp-002',
    companyName: 'Sankaj Logistics Global',
    managerId: 'usr-006',
...
export const INITIAL_USERS: MockUser[] = [
  ...
  },
  {
    id: 'usr-008',
    name: 'Audit Viewer',
    email: 'viewer@sankajlogistics.com',
...
export const INITIAL_INBOUND: MockInboundShipment[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        status: 'IN_PROGRESS',
        employeeName: 'Rohan Deshmukh',
        timestamp: '2026-07-24 08:15 AM',
        remarks: 'Moved to Inbound Staging Zone B for inspection.',
        progress: 50,
      },
      {
        id: 'step-inb-5',
        ...
        timestamp: 'Pending',
        remarks: 'Visual damage check pending.',
        progress: 0,
      },
      {
        id: 'step-inb-6',
...
export const INITIAL_OUTBOUND: MockOutboundOrder[] = [
  {
    ...
    steps: [
      ...
      {
        id: 'step-out-6',
        stepName: 'Handover to Transporter',
        stepOrder: 6,
        status: 'PENDING',
        employeeName: 'Unassigned',
        timestamp: 'Pending',
        remarks: 'Transporter truck handover pending.',
        progress: 0,
      },
      {
        id: 'step-out-7',
